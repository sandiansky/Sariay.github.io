(function (e, t) {
    ...
    var t = Math.round, e = Math.max, n = Math.floor;
    return function (e) {
        function t(i) {
            if (n[i])
                return n[i].exports;
        ...
        var n = function () {
            ...
            }, Object.defineProperty(e.prototype, 'collection', { get: function () {
        ...
        'use strict';
        Object.defineProperty(t, '__esModule', { value: !0 }), n(3), n(4);
        var i = n(5);
        t.Gallery = i.Gallery;
    }, function () {
    }, function () {
        ...
        var l = o(6), a = o(9), r = o(10), s = o(11), d = o(0), p = o(13), c = function () {
            function t(e, t, i, o) {
            ...
            return t.prototype.render = function () {
                ...
                var e = this.scrollElement ? this.scrollElement.clientHeight : document.documentElement.clientHeight, t = e - this.bodyElement.offsetTop, i = n(t / (0.55 * this.options.rowHeight));
                ...
                if (e !== this.bodyWidth) {
                    ...
                    var t = this.collection[this.pswpContainer.length - 1], i = t ? t.row + 1 : this.getRowsPerPage();
                ...
                n = e instanceof Document ? e.documentElement : e, e.addEventListener('scroll', function () {
                    var e = t.rootElement.offsetTop + t.rootElement.offsetHeight + t.options.infiniteScrollOffset, i = n.scrollTop - (n.clientTop || 0), o = n.clientHeight, l = i - t.old_scroll_top;
                ...
                this._selected = [];
            }, Object.defineProperty(t.prototype, 'events', { get: function () {
                return this._events;
            }, enumerable: !0, configurable: !0 }), Object.defineProperty(t.prototype, 'id', { get: function () {
                return this._id;
            }, set: function (e) {
                this._id = e;
            }, enumerable: !0, configurable: !0 }), Object.defineProperty(t.prototype, 'pswpContainer', { get: function () {
                return this._pswpContainer;
            }, set: function (e) {
                this._pswpContainer = e;
            }, enumerable: !0, configurable: !0 }), Object.defineProperty(t.prototype, 'collection', { get: function () {
            ...
            }, enumerable: !0, configurable: !0 }), t.prototype.getOriginalCollection = function () {
                return this._collection;
            }, Object.defineProperty(t.prototype, 'bodyWidth', { get: function () {
                return this._bodyWidth;
            }, set: function (e) {
                this._bodyWidth = e;
            }, enumerable: !0, configurable: !0 }), Object.defineProperty(t.prototype, 'bodyElement', { get: function () {
                return this._bodyElement;
            }, set: function (e) {
                this._bodyElement = e;
            }, enumerable: !0, configurable: !0 }), Object.defineProperty(t.prototype, 'rootElement', { get: function () {
                return this._rootElement;
            }, set: function (e) {
                this._rootElement = e;
            }, enumerable: !0, configurable: !0 }), Object.defineProperty(t.prototype, 'pswpApi', { get: function () {
                return this._pswpApi;
            }, set: function (e) {
                this._pswpApi = e;
            }, enumerable: !0, configurable: !0 }), Object.defineProperty(t.prototype, 'pswpElement', { get: function () {
                return this._pswpElement;
            }, set: function (e) {
                this._pswpElement = e;
            }, enumerable: !0, configurable: !0 }), Object.defineProperty(t.prototype, 'options', { get: function () {
                return this._options;
            }, set: function (e) {
                this._options = e;
            }, enumerable: !0, configurable: !0 }), Object.defineProperty(t.prototype, 'header', { get: function () {
                return this._header;
            }, set: function (e) {
                this._header = e;
            }, enumerable: !0, configurable: !0 }), Object.defineProperty(t.prototype, 'categories', { get: function () {
        ...
        'use strict';
        Object.defineProperty(t, '__esModule', { value: !0 });
        var i = n(0), o = n(7), l = n(8), a = function () {
            function e(e, t) {
            ...
            return e.prototype.getTitle = function (e) {
                ...
                t.innerHTML = e;
                var n = t.getElementsByTagName('a'), i = { title: t.textContent, link: null, linkTarget: null };
                return n[0] && (i.link = n[0].getAttribute('href'), i.linkTarget = n[0].getAttribute('target')), i;
            }, e.prototype.createElement = function () {
                var t = this, e = this.gallery.options, n = null;
                this.title && -1 < ['true', 'hover'].indexOf(e.showLabels) && (n = !0);
                var o = document.createElement('div'), l = document.createElement('div'), a = this.getLinkElement(), r = null;
                ...
                var n = this;
                if (this.gallery.options.lightbox) {
                    var i = Array.prototype.slice.call(e.parentNode.children), a = i.indexOf(e) - 1, r = new o(this.gallery.pswpElement, l, this.gallery.pswpContainer, { index: a, bgOpacity: 0.85, showHideOpacity: !0, loop: !1 });
                ...
                return { src: this._enlarged, w: this._eWidth, h: this._eHeight, title: this._title };
                ...
                this._id = e;
            }, enumerable: !0, configurable: !0 }), Object.defineProperty(e.prototype, 'thumbnail', { get: function () {
                return this._thumbnail;
            }, set: function (e) {
                this._thumbnail = e;
            }, enumerable: !0, configurable: !0 }), Object.defineProperty(e.prototype, 'enlarged', { get: function () {
                return this._enlarged;
            }, set: function (e) {
                this._enlarged = e;
            }, enumerable: !0, configurable: !0 }), Object.defineProperty(e.prototype, 'title', { get: function () {
                return this._title;
            }, set: function (e) {
                this._title = e;
            }, enumerable: !0, configurable: !0 }), Object.defineProperty(e.prototype, 'tWidth', { get: function () {
                return this._tWidth;
            }, set: function (e) {
                this._tWidth = e;
            }, enumerable: !0, configurable: !0 }), Object.defineProperty(e.prototype, 'tHeight', { get: function () {
                return this._tHeight;
            }, set: function (e) {
                this._tHeight = e;
            }, enumerable: !0, configurable: !0 }), Object.defineProperty(e.prototype, 'eWidth', { get: function () {
                return this._eWidth;
            }, set: function (e) {
                this._eWidth = e;
            }, enumerable: !0, configurable: !0 }), Object.defineProperty(e.prototype, 'eHeight', { get: function () {
                return this._eHeight;
            }, set: function (e) {
                this._eHeight = e;
            }, enumerable: !0, configurable: !0 }), Object.defineProperty(e.prototype, 'last', { get: function () {
                return this._last;
            }, set: function (e) {
                this._last = e;
            }, enumerable: !0, configurable: !0 }), Object.defineProperty(e.prototype, 'categories', { get: function () {
                return this._categories;
            }, set: function (e) {
                this._categories = e;
            }, enumerable: !0, configurable: !0 }), Object.defineProperty(e.prototype, 'row', { get: function () {
                return this._row;
            }, set: function (e) {
                this._row = e;
            }, enumerable: !0, configurable: !0 }), Object.defineProperty(e.prototype, 'height', { get: function () {
                return this._height;
            }, set: function (e) {
                this._height = e;
            }, enumerable: !0, configurable: !0 }), Object.defineProperty(e.prototype, 'width', { get: function () {
                return this._width;
            }, set: function (e) {
                this._width = e;
            }, enumerable: !0, configurable: !0 }), Object.defineProperty(e.prototype, 'description', { get: function () {
                return this._description;
            }, set: function (e) {
                this._description = e;
            }, enumerable: !0, configurable: !0 }), Object.defineProperty(e.prototype, 'binded', { get: function () {
                return this._binded;
            }, set: function (e) {
                this._binded = e;
            }, enumerable: !0, configurable: !0 }), Object.defineProperty(e.prototype, 'link', { get: function () {
                return this._link;
            }, set: function (e) {
                this._link = e;
            }, enumerable: !0, configurable: !0 }), Object.defineProperty(e.prototype, 'linkTarget', { get: function () {
                return this._linkTarget;
            }, set: function (e) {
                this._linkTarget = e;
            }, enumerable: !0, configurable: !0 }), Object.defineProperty(e.prototype, 'fields', { get: function () {
                return this._fields;
            }, enumerable: !0, configurable: !0 }), e;
        }();
        t.Item = a;
        ...
        (function (e, t) {
            ...
            return function (n, o, i, l) {
                var a = Math.min, r = Math.abs, s = Math.PI, d = { features: null, bind: function (e, t, n, o) {
                    ...
                    if (d.features)
                        return d.features;
                    var t = d.createEl(), n = t.style, o = '', l = {};
                    if (l.oldIE = document.all && !document.addEventListener, l.touch = 'ontouchstart' in window, window.requestAnimationFrame && (l.raf = window.requestAnimationFrame, l.caf = window.cancelAnimationFrame), l.pointerEvent = navigator.pointerEnabled || navigator.msPointerEnabled, !l.pointerEvent) {
                        ...
                        var p = r.match(/Android\s([0-9\.]*)/), c = p ? p[1] : 0;
                    ...
                    if (!l.raf) {
                        var a = 0;
                        l.raf = function (t) {
                            var n = new Date().getTime(), i = e(0, 16 - (n - a)), o = window.setTimeout(function () {
                                t(n + i);
                            }, i);
                            return a = n + i, o;
                        }, l.caf = function (e) {
                ...
                var c = this, m = 25, u = 3, g = { allowPanToNext: !0, spacing: 0.12, bgOpacity: 1, mouseUsed: !1, loop: !0, pinchToClose: !0, closeOnScroll: !0, closeOnVerticalDrag: !0, verticalDragRange: 0.75, hideAnimationDuration: 333, showAnimationDuration: 333, showHideOpacity: !1, focus: !0, escKey: !0, arrowKeys: !0, mainScrollEndFriction: 0.35, panEndFriction: 0.35, isClickableElement: function (e) {
                    return 'A' === e.tagName;
                ...
                var h, y, f, b, w, x, C, _, v, E, I, k, P, T, S, O, A, D, R, F, L, z, U, N, Z, B, M, H, W, K, q, G, Y, V, X, j, $, J, Q, ee, te, ne, ie, oe, le, ae, re, se, de, pe, ce, me, ue, ge, he, ye, fe, be = function () {
                    return { x: 0, y: 0 };
                }, xe = be(), we = be(), Ce = be(), _e = {}, ve = 0, Ee = {}, Ie = be(), ke = 0, Pe = !0, Te = [], Se = {}, Oe = !1, Ae = function (e, t) {
                    ...
                    if (!g.loop && n) {
                        var i = b + (Ie.x * ve - e) / Ie.x, o = t(e - vt.x);
                    ...
                    z = 'left', d.addClass(n, 'pswp--ie'), Me = function (e, t) {
                        ...
                        if (pe) {
                            var e = pe, t = c.currItem, n = 1 < t.fitRatio ? 1 : t.fitRatio, i = n * t.w, o = n * t.h;
                    ...
                    d();
                }, pt = 30, ct = 10, mt = {}, p = {}, ut = {}, gt = {}, ht = {}, yt = [], ft = {}, bt = [], xt = {}, wt = 0, Ct = be(), _t = 0, vt = be(), Et = be(), It = be(), kt = function (e, t) {
                    ...
                    var n, i, o, l, a = 0, r = Ce[e] + t[e], s = 0 < t[e], d = vt.x + t.x, p = vt.x - ft.x;
                    ...
                    if (!('mousedown' === t.type && 0 < t.button)) {
                        ...
                        if (!(J && 'mousedown' === t.type)) {
                            if (Ft(t, !0) && t.preventDefault(), Le('pointerDown'), U) {
                                ...
                                0 > e && (e = yt.length), yt[e] = { x: t.pageX, y: t.pageY, id: t.pointerId };
                            }
                            var n = Ht(t), i = n.length;
                            le = null, st(), Q && 1 !== i || (Q = ue = !0, d.bind(window, C, c), j = ye = ge = $ = oe = ne = ee = te = !1, me = null, Le('firstTouchStart', n), Ke(we, Ce), xe.x = xe.y = 0, Ke(gt, n[0]), Ke(ht, gt), ft.x = Ie.x * ve, bt = [{ x: gt.x, y: gt.y }], V = Y = ze(), je(E, !0), St(), Ot()), ae || !(1 < i) || ce || oe || (I = E, te = !1, ae = ee = !0, xe.y = xe.x = 0, Ke(we, Ce), Ke(mt, n[0]), Ke(p, n[1]), zt(mt, p, It), Et.x = r(It.x) - Ce.x, Et.y = r(It.y) - Ce.y, re = se = Tt(mt, p));
                        }
                    }
                }, qt = function (t) {
                    ...
                    if (U) {
                        ...
                        if (-1 < n)
                            if (e = yt.splice(n, 1)[0], navigator.pointerEnabled)
                                ...
                                e.type = { 2: 'touch', 3: 'pen', 4: 'mouse' }[t.pointerType], e.type || (e.type = t.pointerType || 'mouse');
                            }
                    }
                    var i, o = Ht(t), l = o.length;
                    if ('mouseup' === t.type && (l = 0), 2 === l)
                        return le = null, !0;
                    1 === l && Ke(ht, o[0]), 0 !== l || me || ce || (!e && ('mouseup' === t.type ? e = { x: t.pageX, y: t.pageY, type: 'mouse' } : t.changedTouches && t.changedTouches[0] && (e = { x: t.changedTouches[0].pageX, y: t.changedTouches[0].pageY, type: 'touch' })), Le('touchRelease', t, e));
                    var a = -1;
                    ...
                    var e, n, i = { lastFlickOffset: {}, lastFlickDist: {}, lastFlickSpeed: {}, slowDownRatio: {}, slowDownRatioReverse: {}, speedDecelerationRatio: {}, speedDecelerationRatioAbs: {}, distanceOffset: {}, backAnimDestination: {}, backAnimStarted: {}, calculateSwipeSpeed: function (t) {
                    ...
                    var o;
                    if ('swipe' === t) {
                        var l = gt.x - ht.x, s = 10 > n.lastFlickDist.x;
                ...
                Ae('Gestures', { publicMethods: { initGestures: function () {
                ...
                var Qt, en, tn, nn, on, ln, an, rn = function (e, t, i, o) {
                    ...
                    var a = i ? g.hideAnimationDuration : g.showAnimationDuration, r = function () {
                    ...
                    (function () {
                        var t = f, o = !c.currItem.src || c.currItem.loadError || g.showHideOpacity;
                        e.miniImg && (e.miniImg.style.webkitBackfaceVisibility = 'hidden'), i || (E = l.w / e.w, Ce.x = l.x, Ce.y = l.y - H, c[o ? 'template' : 'bg'].style.opacity = 1e-3, Ze()), rt('initialZoom'), i && !t && d.removeClass(n, 'pswp--animated-in'), o && (i ? d[(t ? 'remove' : 'add') + 'Class'](n, 'pswp--animate_opacity') : setTimeout(function () {
                            ...
                            if (Le('initialZoom' + (i ? 'Out' : 'In')), !i)
                                ...
                                var s = l.w / e.w, p = { x: Ce.x, y: Ce.y }, c = E, m = he, u = function (e) {
                ...
                }, sn = {}, dn = [], pn = { index: 0, errorMsg: '<div class="pswp__error-msg"><a href="%url%" target="_blank">The image</a> could not be loaded.</div>', forceProgressiveLoading: !1, preload: [1, 1], getNumItemsFn: function () {
                    return en.length;
                } }, cn = function () {
                    ...
                    if (e.src && !e.loadError) {
                        var i = !n;
                        if (i && (!e.vGap && (e.vGap = { top: 0, bottom: 0 }), Le('parseVerticalMargin', e)), sn.x = t.x, sn.y = t.y - e.vGap.top - e.vGap.bottom, i) {
                            var o = sn.x / e.w, l = sn.y / e.h;
                            e.fitRatio = o < l ? o : l;
                            var a = g.scaleMode;
                    ...
                    var t = e.img = d.createEl('pswp__img', 'img'), n = function () {
                    ...
                    if (e.src) {
                        ...
                        var o = i ? e.w : t(e.w * e.fitRatio), l = i ? e.h : t(e.h * e.fitRatio);
                ...
                Ae('Controller', { publicMethods: { lazyLoadItem: function (e) {
                    e = De(e);
                    var t = on(e);
                    ...
                    d.extend(g, pn, !0), c.items = en = i, on = c.getItemAt, ln = g.getNumItemsFn, an = g.loop, 3 > ln() && (g.loop = !1), Fe('beforeChange', function (e) {
                        var t, n = g.preload, i = !(null !== e) || 0 <= e, o = a(n[0], ln()), l = a(n[1], ln());
                        for (t = 1; t <= (i ? l : o); t++)
                            c.lazyLoadItem(b + t);
                        for (t = 1; t <= (i ? o : l); t++)
                            c.lazyLoadItem(b - t);
                    ...
                    if (!o.src && o.html && (o.html.tagName ? l.appendChild(o.html) : l.innerHTML = o.html), yn(o), un(o, _e), o.src && !o.loadError && !o.loaded) {
                        if (o.loadComplete = function (n) {
                            if (h) {
                                if (e && e.index === t) {
                                    ...
                                    n.imageAppended ? !nn && n.placeholder && (n.placeholder.style.display = 'none', n.placeholder = null) : q.transform && (ce || nn) ? dn.push({ item: n, baseDiv: l, img: n.img, index: t, holder: e, clearPlaceholder: !0 }) : gn(t, n, l, n.img, ce || nn, !0);
                                }
                        ...
                        o.loading || hn(o), c.allowProgressiveImg() && (!tn && q.transform ? dn.push({ item: o, baseDiv: l, img: o.img, index: t, holder: e }) : gn(t, o, l, o.img, !0, !0));
                    }
                    else
                ...
                var xn, wn = {}, Cn = function (t, n, i) {
                    var o = document.createEvent('CustomEvent'), e = { origEvent: t, target: t.target, releasePoint: n, pointerType: i || 'touch' };
                    o.initCustomEvent('pswpTap', !0, !0, e), t.target.dispatchEvent(o);
                };
                Ae('Tap', { publicMethods: { initTap: function () {
                ...
                var _n;
                Ae('DesktopZoom', { publicMethods: { initDesktopZoom: function () {
                ...
                Ae('History', { publicMethods: { initHistory: function () {
                ...
                } } }), d.extend(c, { shout: Le, listen: Fe, viewportSize: _e, options: g, isMainScrollAnimating: function () {
                    return ce;
        ...
        (function (t, a) {
            ...
            'use strict';
            return function (n, o) {
                var i, l, e, a, r, s, d, p, c, m, u, g, h, y, f, b, x, w, C = this, _ = !1, v = !0, E = !0, I = { barsSize: { top: 44, bottom: 'auto' }, closeElClasses: ['item', 'caption', 'zoom-wrap', 'ui', 'top-bar'], timeToIdle: 4e3, timeToIdleOutside: 1e3, loadingIndicatorDelay: 1e3, addCaptionHTMLFn: function (e, t) {
                ...
                }, indexIndicatorSep: ' / ', fitControlsWidth: 1200 }, k = function (t) {
                    if (b)
                        return !0;
                ...
                }, K = [{ name: 'caption', option: 'captionEl', onInit: function (t) {
                    e = t;
                    ...
                    A();
                } }, { name: 'button--zoom', option: 'zoomEl', onTap: n.toggleDesktopZoom }, { name: 'counter', option: 'counterEl', onInit: function (e) {
                    r = e;
                } }, { name: 'button--close', option: 'closeEl', onTap: n.close }, { name: 'button--arrow--left', option: 'arrowEl', onTap: n.prev }, { name: 'button--arrow--right', option: 'arrowEl', onTap: n.next }, { name: 'button--fs', option: 'fullscreenEl', onTap: function () {
        ...
        var i = n(0), o = function () {
            ...
            return e.prototype.addFilter = function (e) {
                ...
                this._collection = e;
            }, enumerable: !0, configurable: !0 }), Object.defineProperty(e.prototype, 'element', { get: function () {
                return this._element;
            }, set: function (e) {
                this._element = e;
            }, enumerable: !0, configurable: !0 }), Object.defineProperty(e.prototype, 'gallery', { get: function () {
                return this._gallery;
            }, set: function (e) {
                this._gallery = e;
            }, enumerable: !0, configurable: !0 }), Object.defineProperty(e.prototype, 'filters', { get: function () {
        ...
        Object.defineProperty(t, '__esModule', { value: !0 });
        var o = n(1), l = n(12), a = n(0), r = function (e) {
            function t(t) {
                var n = e.call(this, t) || this;
                return n.header = t, n._categories = [], n;
            }
            return i(t, e), Object.defineProperty(t.prototype, 'element', { get: function () {
                return this._element;
            }, set: function (e) {
                this._element = e;
                ...
                this.header.filter();
            }, Object.defineProperty(t.prototype, 'categories', { get: function () {
                return this._categories;
            }, set: function (e) {
                this._categories = e;
            }, enumerable: !0, configurable: !0 }), Object.defineProperty(t.prototype, 'others', { get: function () {
                return this._others;
            }, set: function (e) {
                this._others = e;
            }, enumerable: !0, configurable: !0 }), Object.defineProperty(t.prototype, 'none', { get: function () {
                return this._none;
            }, set: function (e) {
                this._none = e;
            }, enumerable: !0, configurable: !0 }), t;
        ...
        var i = n(0), o = function () {
            ...
            return e.prototype.render = function () {
                ...
                this._title = e;
            }, enumerable: !0, configurable: !0 }), Object.defineProperty(e.prototype, 'isActive', { get: function () {
        ...
        (function (e) {
            ...
            e.organize = function (e) {
                ...
                var t = e.options.margin ? e.options.margin : 0, n = o(e.options.rowHeight * e.defaultImageRatio + t), i = (e.bodyWidth + t) / (n + t);
                return o(i);
                ...
                for (var l = 1; l <= e.length; l++) {
                    var a = e.slice(0, l), r = this.getRowWidth(n, i, a);
                    if (r >= t) {
                ...
                for (var s = o ? this.getRowHeight(o, l, e) : r, d = this.getRowWidth(s, l, e), p = o ? this.apportionExcess(e, o, d) : 0, c = 0, m = 0; m < e.length; m++) {
                    var i = e[m], u = this.getImageRatio(i) * s - p;
